...
class StackLayer:
    ...
    def final_stacker(self, blender_x_tree, blender_test_tree, blender_x_g_tree, blender_test_g_tree):
        ...
        model.binary_train(self.pred_path, self.loss_log_path, csv_log_path=self.csv_log_path, n_valid=self.n_valid,
    ...
    def train(self, i_epoch=1):
        ...
        if self.i_layer != 1:
            ...
            for epoch in range(self.n_epoch):
                ...
                # Training Lower layer
                blender_x_e, blender_test_e, _, _ = self.input_layer.binary_train(epoch + 1)
