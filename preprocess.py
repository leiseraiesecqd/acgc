...
class DataPreProcess:
    ...
    def drop_outliers_by_value(self):
        ...
        self.drop_feature_outliers_by_value('feature1', 19.75, None)
        ...
        self.drop_feature_outliers_by_value('feature15', 14.26, None)
        self.drop_feature_outliers_by_value('feature16', None, None)
        ...
        self.drop_feature_outliers_by_value('feature29', 12, None)
        ...
        self.drop_feature_outliers_by_value('feature45', 5.62, None)
        self.drop_feature_outliers_by_value('feature46', 31.25, None)
        self.drop_feature_outliers_by_value('feature47', None, None)
        self.drop_feature_outliers_by_value('feature48', None, None)
        self.drop_feature_outliers_by_value('feature49', 6.49, None)
        ...
        self.drop_feature_outliers_by_value('feature85', None, None)
        self.drop_feature_outliers_by_value('feature86', None, None)
        self.drop_feature_outliers_by_value('feature87', 25.52, None)
